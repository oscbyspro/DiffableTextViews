...
public struct Attribute: OptionSet {
    ...
    public struct Domain {
        public static let all:    Self = .init(normal.attribute, extras.attribute)
        public static let normal: Self = .init(.formatting, .lookahead, .lookbehind, .insertable, .removable)
    ...
    public struct Theme {
        public static let nondiffable: Self = .init(.insertable, .removable)
    ...
    public struct Intuitive {
        ...
        public static let prefix:  Self = .init(.formatting, .insertable, .removable, .lookahead)
        public static let suffix:  Self = .init(.formatting, .insertable, .removable,             .lookbehind)
        public static let spacer:  Self = .init(.formatting, .insertable, .removable, .lookahead, .lookbehind)
