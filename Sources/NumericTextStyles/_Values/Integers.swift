...
///
public protocol NumberTextInteger: _NumberTextValue, _UsesIntegerPrecision, FixedWidthInteger {
...
extension UInt: NumberTextInteger {
    ...
    public typealias NumberTextParser = _UnsignedIntegerParser
...
extension Int: NumberTextInteger {
    ...
    public typealias NumberTextParser = _IntegerParser
